...
ds = xr.open_mfdataset("D://thesisdata/plankton/marine_copernicus/2009/*.nc")
...
for time in pd.date_range('2009-09-23','2009-09-23',freq='d'):
    ...
    ax1.set_title(str(time)[:10]+' daily interpolated')
    path = 'D://thesisdata/bilder/python/chl_a/marine_cds/'
