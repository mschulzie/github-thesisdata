...
R = ds['R'].sel(lon_shift=0,lat_shift=0)
cov = ds['cov'].sel(lon_shift=0,lat_shift=0)
rho = ds['rho'].sel(lon_shift=0,lat_shift=0)
#%%
...
fig.savefig('D://thesisdata/bilder/Python/wrf_chla/correlation/'
        +'correlation_perfect_spatial_shift_lonlat0'+add+'.png'
...
fig2.savefig('D://thesisdata/bilder/Python/wrf_chla/correlation/section_crosscorr_lonlat0'+
        add+'.png'
        ,dpi=200,facecolor='white',
        bbox_inches = 'tight',pad_inches = 0.01)
