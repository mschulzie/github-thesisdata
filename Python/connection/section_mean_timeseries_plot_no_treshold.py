...
for i,ort in enumerate(sections):
    ...
    #RECHTE SEITE:
    chl_ano = chl[ort+';'+'CHL']-chl[ort+';'+'CHL_mean']
    ...
    ax2[ort].fill_between(t,chl[ort+';'+'CHL']-chl[ort+';'+'CHL_mean']-chl[ort+';'+'CHL_error'],
        chl[ort+';'+'CHL']-chl[ort+';'+'CHL_mean']+chl[ort+';'+'CHL_error'],
        color='#9d1c3f',facecolor='#fbe0f9',label=r'$\mu_{\Delta C}(t)$')
    ax2[ort].fill_between(t,-chl[ort+';'+'CHL_standard_deviation'],chl[ort+';'+'CHL_standard_deviation'],
        color='#0094ff',facecolor='#b0d9fb',label=r'$\mu_\sigma (t)$',
        alpha=.5)
...
plt.tight_layout()
fig.savefig('D://thesisdata/bilder/Python/wrf_chla/timeseries_all_without_coast_no_treshold'+add+'.png'
