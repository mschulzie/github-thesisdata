...
#%% Plotting:
scale= 10
extent = [110,189,-57,-10]
fig = plt.figure(figsize=(10,3))
gs = fig.add_gridspec(2,3,hspace=.05,wspace=.05,height_ratios=[12,1])
LON, LAT = np.meshgrid(u.lon.values, u.lat.values)
for i,time in enumerate(pd.date_range('2009-09-22T00','2009-09-22T12',freq='6h')):
    ...
    ax.add_feature(cfeature.STATES, lw=.5, zorder=4)
    im = dt.plot(
...
plt.show()
fig.savefig('D://thesisdata/bilder/Python/era5/wind/wind_reddawn_small.png',
