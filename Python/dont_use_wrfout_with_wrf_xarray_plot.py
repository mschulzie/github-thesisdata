...
var = var.rename({"Time":"time","west_east":"lon", "south_north": "lat"})
extent = [111,179,-9,-57]
cart_proj = get_cartopy(var)
var.coords
fig = plt.figure(dpi=200)
ax = fig.add_subplot(1,1,1, projection=ccrs.PlateCarree(central_longitude=150.0))
...
im = var.sel(time='2009-09-29T18').plot(ax=ax, cmap='viridis',
            transform=ccrs.Mercator(central_longitude=150.0),zorder=6)
