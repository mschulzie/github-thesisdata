...
options = ['DUST_SOILFEWETDEP_ACC_','DUST_SOILFEGRASET_ACC_','DUST_SOILFEDRYDEP_ACC_']
fig = plt.figure(figsize=(8,3.2))
gs = fig.add_gridspec(1,3,hspace=0.3,wspace=0.1)
savename = 'iron_deposition_vars'
cmap = 'pink_r'
count = 0
for var in options:
    sum_name = var[:-1]
    ...
    cont = dep.plot(ax=ax,transform=crs.PlateCarree(),
        ...
        levels=10,norm=LogNorm(vmin=1e-3,vmax=1e4))
...
cb_d.set_label('Eiseneintrag in µg/m2')
plt.show()
