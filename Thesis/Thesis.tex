...
Der statistische Zusammenhang zwischen Kohlenstoffdioxidkonzentrationen und der mittleren Temperatur an der Erdoberfläche ist eindeutig. Durch die Analyse von Eisbohrkernen in den  1980'er Jahren konnte  gezeigt werden, dass die \cotwo Konzentrationen in den letzten 800.000 Jahren stark mit den Temperaturen korrelieren. Andere Methoden für die Zeiten davor und insbesondere die immer genauer werdenden Ableitungen und Messungen der jüngeren Vergangenheit bestätigen diese Beobachtung. Darüber hinaus kann der sogenannte \textit{Treibhauseffekt} für \cotwo und andere Treibhausgase (insbesondere relevant und häufig genannt: Wasser, Methan, Stickoxide) in unzweifelhaft experimentell nachgewiesen werden. Trotz dieser eindeutigen Indizien ist es allerdings weiterhin schwierig, aus den verfügbaren Zeitreihen statistisch eine klare Kausalität zu beweisen. Dies impliziert, dass die beobachtete Korrelation theoretisch auch aufgrund eines anderen externen Treibers, der beide Größen \cotwo Konzentration und mittlere Temperaturen beeinflusst, verursacht sein könnte. Allerdings geben auch neuere statistische Methoden 
