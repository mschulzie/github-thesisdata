...
Für die Zeitreihenanalyse werden alle Gitterzellen betrachtet, für die von der WRF-Simulation entsprechend hohe Eisendepositionen simuliert wurden. Um das Gebiet sinnvoll einzugrenzen, muss der gesamte Eintrag für die jeweilige Zelle so groß sein, dass dadurch die \textit{normalen} Eisenkonzentrationen nennenswert erhöht werden. Auf Basis von Abbildung \ref{fig:nutrient_iron} wird angenommen, dass diese für den überwiegenden Teil der zu untersuchenden Region mindestens etwa 0.066 nM (Nanomol pro Liter) betragen. Darüber hinaus wird zur Abschätzung der Erhöhung der Eisenkonzentrationen $\text{Fe}_{c}$ durch Deposition angenommen, dass der überwiegende Teil der Nährstoffe in den oberen $z_0 = 10$m des Oberflächenwassers konsumiert wird. Mit den $M_{\text{Fe}} =  55.845$ g/mol Molmasse des Elements Eisen ergibt sich dann ausgehend der vom Modell simulierten Eisendeposition $Fe_{in}$ in g/qm:
\begin{equation}
